    ...
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50  ${
          isScroll
            ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-dartTheme dark:shadow-white/20"
            : ""
        }`}
      >
        <a href="#top">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#contact"
            className="dark:border-white/50 hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo"
          >
            Contact{" "}
            <Image
